...
Version  : 2.6.0
Release  : 6
URL      : https://cran.r-project.org/src/contrib/eha_2.6.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/eha_2.6.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1545669166
...
R CMD INSTALL --install-tests --built-timestamp=${SOURCE_DATE_EPOCH} --build  -l %{buildroot}/usr/lib64/R/library eha
for i in `find %{buildroot}/usr/lib64/R/ -name "*.so"`; do mv $i $i.avx2 ; mv $i.avx2 ~/.stash/; done
echo "CFLAGS = $CFLAGS -march=skylake-avx512 -ftree-vectorize " > ~/.R/Makevars
echo "FFLAGS = $FFLAGS -march=skylake-avx512 -ftree-vectorize " >> ~/.R/Makevars
echo "CXXFLAGS = $CXXFLAGS -march=skylake-avx512 -ftree-vectorize " >> ~/.R/Makevars
R CMD INSTALL --preclean --install-tests --no-test-load --built-timestamp=${SOURCE_DATE_EPOCH} --build  -l %{buildroot}/usr/lib64/R/library eha
for i in `find %{buildroot}/usr/lib64/R/ -name "*.so"`; do mv $i $i.avx512 ; mv $i.avx512 ~/.stash/; done
echo "CFLAGS = $CFLAGS -ftree-vectorize " > ~/.R/Makevars
echo "FFLAGS = $FFLAGS -ftree-vectorize " >> ~/.R/Makevars
echo "CXXFLAGS = $CXXFLAGS -ftree-vectorize " >> ~/.R/Makevars
R CMD INSTALL --preclean --install-tests --built-timestamp=${SOURCE_DATE_EPOCH} --build  -l %{buildroot}/usr/lib64/R/library eha
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library eha|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/eha/doc/parametric.Rnw
/usr/lib64/R/library/eha/doc/parametric.pdf
...
/usr/lib64/R/library/eha/libs/symbols.rds
